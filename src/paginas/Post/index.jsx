...
import BotaoPrincipal from "@/componentes/BotaoPrincipal"; // ← Importação
...
const Post = () => {
    ...
    useEffect(() => {
        const aoFazerScroll = () => {
            const distanciaFaltando = document.body.offsetHeight - window.innerHeight - window.scrollY;
                        ...
                        >
                            ...
                            {mostrarBotaoTopo && (
                                <div className={styles.botaoTopoWrapper}>
                                    <BotaoPrincipal tamanho="lg" onClick={voltarAoTopo}>
                                        Voltar para o topo
                                    </BotaoPrincipal>
                                </div>
                            )}
